...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Electric Utility Operations Management System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Utility Operation";
process.env.TABLE_NAME = process.env.TABLE_NAME || "utility_operation_records";
'use strict';
